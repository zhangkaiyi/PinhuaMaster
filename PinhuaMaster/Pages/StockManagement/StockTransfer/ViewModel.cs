...
namespace PinhuaMaster.Pages.StockManagement.StockTransfer.ViewModel
{
    public class StockTransferViewModel
    {
        public StockTransferMainDTO Main { get; set; } = new StockTransferMainDTO();
        public List<StockTransferDetailsDTO> Details { get; set; } = new List<StockTransferDetailsDTO>();
    ...
    public class StockTransferMainDTO
    {
    ...
    public class StockTransferSearch
    {
        [Display(Name = "单号")]
        public string OrderId { get; set; }
        [Display(Name = "客户编号")]
    ...
    public class StockTransferProfile : Profile
    {
        ...
        {
            CreateMap<StockTransferMain, StockTransferMainDTO>();
            ...
            CreateMap<StockTransferMainDTO, StockTransferMain>();
            //.ForMember(dst => dst.ExcelServerRcid, map => map.MapFrom(src => src.ExcelServerRcid))
            //.ForMember(dst => dst.DeliveryDate, map => map.MapFrom(src => src.DeliveryDate));

            CreateMap<StockTransferDetails, StockTransferDetailsDTO>();
            //.ForMember(dst => dst.DeliveryId, map => map.MapFrom(src => src.Id.ToString()));
            CreateMap<StockTransferDetailsDTO, StockTransferDetails>();
