    ...
    public class CreateModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                var main = _mapper.Map<StockSubconctractingMainDTO, StockSubconctractingMain>(Order.Main);
                ...
                var details = _mapper.Map<List<StockSubconctractingDetailsDTO>, List<StockSubconctractingDetails>>(Order.Details);
                details.ForEach(i =>
                {
                ...
                _pinhuaContext.StockSubconctractingMain.Add(main);
                _pinhuaContext.StockSubconctractingDetails.AddRange(details);
