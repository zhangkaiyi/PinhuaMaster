...
namespace PinhuaMaster.Pages.StockManagement.StockIn.ViewModel
{
    ...
    public class StockInProfile : Profile
    {
        ...
        {
            CreateMap<StockInMain, StockInMainDTO>();
